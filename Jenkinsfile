    ...
    stages {
        ...
        stage("Push docker image to AWS ECR") {
            ...
            steps {
                ...
                sh "docker_pass=`aws ecr get-login --no-include-email --region us-west-2 | awk '{print \$6}'` && echo ${docker_pass} && echo ${AWS_ECR_URL} && docker login -u AWS -p ${docker_pass} ${AWS_ECR_URL}"
